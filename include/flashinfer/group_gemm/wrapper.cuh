...
cudaError_t CutlassSegmentGEMMWrapper(CutlassSegmentGEMMHandler* handler, DTypeIn* x, DTypeIn* w,
  ...
  if (compute_capacity.first == 8) {
    ...
    using TileShape = Shape<_256, _128, _128>;
        // std::conditional<is_fp8, Shape<_256, _128, _128>,
        //                 Shape<_128, _64, _64>>;  // Threadblock-level tile size
    using ClusterShape = Shape<_2, _2, _1>;
        // std::conditional<is_fp8, Shape<_2, _2, _1>,
    ...
    using KernelSchedule = cutlass::gemm::KernelPtrArrayTmaWarpSpecializedCooperativeFP8FastAccum;
        // std::conditional<is_fp8, 
        //                 cutlass::gemm::KernelPtrArrayTmaWarpSpecializedCooperativeFP8FastAccum,
        //                 cutlass::gemm::KernelPtrArrayTmaWarpSpecializedCooperative>;  // Kernel to launch
